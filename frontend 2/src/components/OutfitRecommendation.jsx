...
const sampleRecommendations = [
  {
    ...
    items: [
      ...
      { name: 'White Button-Down Shirt', category: 'Top', price: '$45', brand: 'Oxford' },
      { name: 'Gray Slim-Fit Pants', category: 'Bottom', price: '$65', brand: 'Slate' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'White T-shirt', category: 'Top', price: '$25', brand: 'Basics' },
  ...
  },
  {
    ...
    imageUrl: 'https://via.placeholder.com/600x800?text=Summer+Outfit',
...
export default function OutfitRecommendation() {
  ...
  // Navigate to next outfit with animation
  const nextOutfit = () => {
    setIsLoading(true);
    setTimeout(() => {
  ...
  // Navigate to previous outfit with animation
  const prevOutfit = () => {
    setIsLoading(true);
    setTimeout(() => {
        ...
        {isLoading ? (
          ...
          >
            ...
            <div className="relative w-full md:w-1/2 aspect-[4/3] md:aspect-auto flex-shrink-0 flex items-center justify-center overflow-hidden group">
              ...
              {/* Navigation arrows */}
              <div className="hidden md:flex absolute inset-y-0 left-0 right-0 justify-between items-center px-2 pointer-events-none z-20">
                <motion.button
                  whileHover={{ scale: 1.1, backgroundColor: 'rgba(255, 255, 255, 0.9)' }}
                  whileTap={{ scale: 0.9 }}
                  onClick={prevOutfit}
                  className="p-2 rounded-full bg-white/80 text-navy-800 hover:bg-white shadow-md z-10"
                >
              ...
              <div className="absolute top-4 right-4 md:top-6 md:right-6 z-30">
                <div className="backdrop-blur-lg bg-white/40 dark:bg-navy-800/60 border border-white/30 dark:border-navy-700/60 shadow-xl rounded-2xl flex flex-row md:flex-col p-2 md:p-3 space-x-2 md:space-x-0 md:space-y-3 transition-all">
                  <motion.button
                    ...
                    className={`w-12 h-12 flex items-center justify-center rounded-full shadow-md border border-white/40 dark:border-navy-700 bg-white/80 dark:bg-navy-800/80 text-navy-600 dark:text-navy-100 hover:bg-opacity-90 hover:shadow-primary-400/40 transition-all ${isFavorite ? 'bg-red-500 text-white' : ''}`} title="Favorite"
                  >
                    {isFavorite ? (
                  ...
                  <motion.button
                    ...
                    className={`w-12 h-12 flex items-center justify-center rounded-full shadow-md border border-white/40 dark:border-navy-700 bg-white/80 dark:bg-navy-800/80 text-navy-600 dark:text-navy-100 hover:bg-opacity-90 hover:shadow-primary-400/40 transition-all ${isSaved ? 'bg-primary-500 text-white' : ''}`} title="Save"
                  >
                    {isSaved ? (
                  ...
                  <motion.button
                    whileHover={{ scale: 1.15, boxShadow: '0 4px 24px 0 rgba(80,120,255,0.25)' }}
                    whileTap={{ scale: 0.93 }}
                    className="w-12 h-12 flex items-center justify-center rounded-full shadow-md border border-white/40 dark:border-navy-700 bg-white/80 dark:bg-navy-800/80 text-navy-600 dark:text-navy-100 hover:bg-opacity-90 hover:shadow-primary-400/40 transition-all" title="Share"
                  >
