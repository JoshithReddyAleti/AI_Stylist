...
CREATE TABLE IF NOT EXISTS `CSC_4710_Project`.`With_Accessory` (
  ...
  `Accessory` INT NOT NULL COMMENT 'Must be categorized as ‘Isother’ from the ',
  PRIMARY KEY (`Parent_Outfit_ID`, `Accessory`),
